        ...
        if (niceCX.cartesianLayout) {
            _.forEach(niceCX.cartesianLayout.elements, function (element) {
                if (element.z) {
                    ...
                    const ePrecision = precision(element.z);
                    if (ePrecision > maxPrecision) {
                        maxPrecision = ePrecision;
                    }
                }
            });
        }   
        ...
        if (niceCX.cartesianLayout) {
            _.forEach(niceCX.cartesianLayout.elements, function (element) {
                if (element.z) {
                    ...
                    nodeSpecificStyle.css['z-index'] = (element.z + (-1 * offset)) * (Math.pow(10, maxPrecision));
                }
            });
        }
